...
public class UpdateClinicGUI extends JFrame {
	...
	public UpdateClinicGUI(Clinic clinic) {
		...
		btn_updateClinic.setFont(new Font("Yu Gothic UI Semibold", Font.PLAIN, 20));
		btn_updateClinic.setBackground(Color.WHITE);
		btn_updateClinic.setBounds(10, 64, 191, 35);
